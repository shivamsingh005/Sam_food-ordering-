                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/Shivamsingh005" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
                              <a href="www.whatsappweb.com" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-whatsapp"></i></a>
                            </div>
                          </div>
                        </div>';
                  ?>
